...
SAMPLE_FILE = "Test_Image-2025-05-11-1951-08-raw.json"
"raw_llm_responses/Claude 3.5 Sonnet/Test_Image-2025-05-11-1951-08-raw.json"
...
class BedrockImageProcessor(ImageProcessor):
    def __init__(self, api_key, prompt_name, prompt_text, model, modelname, include_random_error=False):
    ...
    def process_image(self, base64_image: str, image_name: str, image_index: int) -> Tuple[str, Dict[str, Any]]:
        ...
        try:
            ...
            #print(f"error coming your way: {text = }")
...
class ClaudeImageProcessor(BedrockImageProcessor):
    ...
    def fieldnames_check(self, d):
        return sum([fieldname in d for fieldname in self.fieldnames]) > len(self.fieldnames) / 2
